...
program
   .command(chalk.bold.red('copy'))
   .description(chalk.blue('copy dashboard template across all users'))
...
program
   .command(chalk.bold.red('reset'))
   .description(chalk.blue('reset report data for all sites'))
